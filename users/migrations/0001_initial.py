    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(blank=True, decimal_places=2, default=0.0, editable=False, max_digits=100, null=True)),
                ('_type', models.CharField(choices=[('reversed', 'reversed'), ('credit', 'credit'), ('debit', 'debit'), ('failed', 'failed')], max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
